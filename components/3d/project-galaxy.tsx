    ...
    projects: [
      {
        ...
        category: "backend",
        description:
          "Scalable API gateway with intelligent rate limiting, JWT authentication, circuit breakers, and real-time performance monitoring dashboard.",
        technologies: ["Node.js", "Redis", "Docker", "AWS", "Nginx"],
        github: "https://github.com",
        demo: "https://demo.com",
        year: "2023",
      ...
      },
      {
        ...
        category: "backend",
        description:
          "Enterprise-grade authentication microservice with OAuth 2.0, multi-factor authentication, session management, and audit logging.",
        technologies: ["Express", "PostgreSQL", "Redis", "JWT", "Passport.js"],
        github: "https://github.com",
        demo: "https://demo.com",
        year: "2023",
    ...
    projects: [
      {
        ...
        category: "ai",
        description:
          "Real-time AI-powered chat application with natural language processing, context-aware responses, and multi-model support for different use cases.",
        technologies: ["React", "Node.js", "OpenAI API", "WebSocket", "LangChain"],
        github: "https://github.com",
        demo: "https://demo.com",
        year: "2024",
        role: "AI Engineer",
      },
      {
        ...
        category: "ai",
        description:
          "Visual prompt engineering IDE with version control, A/B testing, token analytics, and one-click deployment to multiple LLM providers.",
        technologies: ["Next.js", "Python", "FastAPI", "OpenAI", "Vercel AI SDK"],
        github: "https://github.com",
        demo: "https://demo.com",
        year: "2024",
        role: "Full Stack Developer",
      ...
      {
        id: 8,
        name: "ML Model Visualizer",
        category: "ai",
        description:
          "Interactive neural network visualization tool with layer-by-layer activation inspection, gradient flow animation, and model comparison.",
        technologies: ["Python", "D3.js", "TensorFlow.js", "Flask", "WebGL"],
        github: "https://github.com",
        demo: "https://demo.com",
        year: "2023",
        role: "ML Engineer",
  ...
  opensource: {
    ...
    projects: [
      ...
      },
      {
        ...
        category: "opensource",
        description:
          "Utility library with 50+ zero-dependency TypeScript helpers for common developer tasks — string manipulation, async control, and data transformation.",
      ...
      },
      {
        ...
        category: "opensource",
        description:
          "Comprehensive React component library with TypeScript support, Storybook docs, and accessibility-first design for modern web applications.",
        technologies: ["React", "TypeScript", "Storybook", "Rollup", "Tailwind CSS"],
        github: "https://github.com",
        demo: "https://demo.com",
        year: "2024",
        role: "Developer",
